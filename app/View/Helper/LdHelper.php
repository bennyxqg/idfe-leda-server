 ...
 * @package       app.View.Helper
 */
class LdHelper extends BaseHelper
{
    public $site_id = 68;
    ...
    function indexInitData(){
        //新闻
        $news = $this->getContentByCategoryIdAndSiteId($this->site_id, 196, 0, $this->limit, 1);
        //公告
        $gong_gao = $this->getContentByCategoryIdAndSiteId($this->site_id, 204, 0, $this->limit, 1);
        //活动
        $huo_dong = $this->getContentByCategoryIdAndSiteId($this->site_id, 206, 0, $this->limit, 1);
        //攻略 
        $gong_lv = $this->getContentByCategoryIdAndSiteId($this->site_id, 202, 0, $this->limit, 1);

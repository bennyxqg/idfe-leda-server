 ...
 * @package       app.View.Helper
 */
class TntgdHelper extends BaseHelper
{
    public $site_id;
    ...
    function indexInitData(){
        //新闻
        $news = $this->getContentByCategoryIdAndSiteId($this->site_id, 235, 0, $this->limit, 1);
        //公告
        $gong_gao = $this->getContentByCategoryIdAndSiteId($this->site_id, 236, 0, $this->limit, 1);
        //攻略
        $gong_lv = $this->getContentByCategoryIdAndSiteId($this->site_id, 237, 0, $this->limit, 1);

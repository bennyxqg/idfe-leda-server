 ...
 *
 */
class JZWHelper extends BaseHelper {
    public $siteId;
    public $limit;
//     public $specialCategoryId = ''; // 正式环境公告 此新闻分类不在正常的新闻列表中显示
    public $specialCategoryId = 222; // localhost 公告 此新闻分类不在正常的新闻列表中显示
    public $gonglvezhiyinid=225;
    public $youxixinwenid=224;
    public $jizhandaquanid=227;
    /**
     * 初始化
     * @param unknown $data
     */

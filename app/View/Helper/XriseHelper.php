 ...
 *
 */
class XriseHelper extends BaseHelper {
    public $siteId;
    public $limit;
...
//     public $propCateId = 95; // localhost 道具大全分类
    public $specialCategoryId = 215; // 正式环境公告 此新闻分类不在正常的新闻列表中显示
    public $roleCateId = 216; // 正式环境 人物大全分类
    public $propCateId = 217; // 正式环境 道具大全分类

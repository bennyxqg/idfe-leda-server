 ...
 * @package       app.View.Helper
 */
class TpHelper extends BaseHelper
{
    public $site_id = 10;//37;
    ...
    function topData(){
        ...
        //活动
        $huo_dong = $this->getContentByCategoryIdAndSiteId($this->site_id, 23, 0, 6, 1);//
        //攻略
        $gong_lue = $this->getContentByCategoryIdAndSiteId($this->site_id, 21, 0, 6, 1);//
        //公告
        $gong_gao = $this->getContentByCategoryIdAndSiteId($this->site_id, 102, 0, 6, 1);//76
        
        //游戏资料
        $yx_zl = $this->getContentByCategoryIdAndSiteId($this->site_id, 104, 0, 6, 1);//78
        //获取轮转图
        ...
        $index_qrcode_img_block = $this->getBlock($this->site_id, "index_qrcode_img",true);

        return compact("yx_zl","gong_gao", "news", "huo_dong","gong_lue", "total","img_index_4", "img_index_1","img_index_2","img_index_3","hzyl","site_block","desc_block","index_qrcode_img_block");

 ...
 *
 */
class BlHelper extends BaseHelper {
//     public $specialCategoryId = 93; // localhost 公告 此新闻分类不在正常的新闻列表中显示
    public $specialCategoryId = 124; // 公告 此新闻分类不在正常的新闻列表中显示
    ...
    public function init($data){
        ...
        $this->limit = isset($data['limit']) ? (int)$data['limit'] : 5;
    }

...
<div class="index1">
	<div class="wrap">
    	<img class="img-code" src="<?php BLOCK('game_download_qrcode') ?>" />
        <a class="wxin-btn" href="javascript:;"></a>
        <div class="wxin-pop"><img src="<?php BLOCK('weixin_qrcode') ?>" /></div>
    </div>
</div>
<div class="index2">
	<div class="wrap">
	...
	<div class="wrap">
    	<div class="focus-img">
        	<div class="swiper-container">
                ...
                <?php
            	SHOW_DATAS('<div class="swiper-slide"><img src="@@STR2@@" /></div>','m/d',0,100,array());
            	?>
        ...
        <div class="news-box">
            ...
            <a class="more" href="http://kp.uu.cc/news/98.html" target="_blank"></a>
            <ul>
            <?php
            $class = 'new';
            		SHOW_NEWS('<li><em class="@@CLASS@@">@@CATEGORY_NAME@@</em><a href="@@URL@@" target="_blank">@@TITLE@@</a><span>@@DATE@@</span></li>','m/d',array('新闻','活动','公告'),5,0,array('class' => array(354=>'new',355=>'act',356=>'anm')));
            	?>
            	<!--

<div class="footer">
    <div class="wrap">
        <span class="logo"><img src="<?php FILE_PATH() ?>/img/ft_logo1.png"><img src="<?php FILE_PATH() ?>/img/ft_logo2.png?v=0"></span>
        <div class="cr">
            ...
            <p> <span>Copyright©2009-2017  深圳市创梦天地科技股份有限公司  版权所有  粤ICP备11018438号</span> <a target="_blank" href="//www.sznet110.gov.cn/netalarm/index.jsp"> <img src="<?php FILE_PATH() ?>/img/shenwang.jpg" width="16" alt="深圳网络警察报警平台"> </a> <a target="_blank" href="//www.sznet110.gov.cn/webrecord/doquery.jsp"> <img src="<?php FILE_PATH() ?>/img/anwang.jpg" alt="公共信息安全网络监察" width="16"> </a> <a target="_blank" href="//net.china.com.cn/index.htm"> <img src="<?php FILE_PATH() ?>/img/jubao.jpg" alt="经营性网站备案信息" width="16"> </a> <a target="_blank" href="//www.miitbeian.gov.cn/publish/query/indexFirst.action"> <img src="<?php FILE_PATH() ?>/img/beian.jpg" alt="不良信息举报中心" width="16"> </a></p>
        </div>

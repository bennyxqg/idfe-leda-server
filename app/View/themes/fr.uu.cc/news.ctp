      ...
      <div id="header">
        ...
        <div class="nav">
            <ul>
                ...
                <li><a class="on" href="//fr.uu.cc/news/98.html" target="_self"><em>NEWS</em>新闻资讯</a><span>/</span></li>
                <li><a href="//fr.uu.cc/game_data/334.html" target="_self"><em>GAME DATA</em>游戏资料</a><span>/</span></li>
    	...
    	<div class="wrap">
        	<div class="pr page_nav">
            	...
            	<a <?php if ($category_id == 'all') echo 'class="on"';?> href="//fr.uu.cc/news/98.html" target="_self">综合</a>
                    <a <?php if ($category_id == 331) echo 'class="on"';?>href="//fr.uu.cc/news/331.html" target="_self">公告</a>
                    <a <?php if ($category_id == 330) echo 'class="on"';?>href="//fr.uu.cc/news/330.html" target="_self">新闻</a>

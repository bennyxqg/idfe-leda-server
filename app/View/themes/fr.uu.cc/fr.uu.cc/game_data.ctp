    ...
    <div class="pg-header">
        ...
        <div class="nav">
            <ul>
                ...
                <li><a class="on" href="//fr.uu.cc/game_data/334.html" target="_self">游戏资料</a><em></em></li>
    ...
    <div class="page_main">
    	<div class="wrap">
        	<div class="pr page_nav">
            	...
            	<a <?php if ($category_id == 334) echo 'class="on"';?> href="//fr.uu.cc/game_data/334.html" target="_self">入门</a>
                    <a <?php if ($category_id == 335) echo 'class="on"';?>href="//fr.uu.cc/game_data/335.html" target="_self">进阶</a>
                    <a <?php if ($category_id == 336) echo 'class="on"';?>href="//fr.uu.cc/game_data/336.html" target="_self">系统</a>
            ...
            <div class="news_list">
            	...
            	<?php foreach($consulting as $k=>$v):?>
            	   <li>
                    	<a class="news_tit" href="//fr.uu.cc/show/<?php echo $v['id'];?>.html" target="_blank"><?php echo $v['title'];?></a>
                        ...
                        <a class="news_go" href="//fr.uu.cc/show/<?php echo $v['id'];?>.html" target="_blank"></a>
                    </li>
...
<div class="right-pop-active">
    ...
    <img class="down-code" src="<?php echo $config_data['other']['game_download_qrcode']; ?>" />
    <div class="down-links">
    	<a href="<?php echo $config_data['other']['android_download_url']; ?>" target="_blank">安卓下载</a>
        <a href="<?php echo $config_data['other']['ios_download_url']; ?>" target="_blank">iOS下载</a>
    </div>

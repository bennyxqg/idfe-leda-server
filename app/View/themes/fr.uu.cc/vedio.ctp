...
$this->Website->init();
//引入TankeHelper
$data=$this->Frxxz->getVedio(5,$page);
   ...
   <div id="xjtj" class="xjtj_n" style="width:920px;">
      ...
      <div class="xj_container" id="xj_container">
          <ul class="xj_bar"  id="xj_bar">
             <a href="//fr.uu.cc/images/6/1.html">游戏截图</a>
             <a href="//fr.uu.cc/vedio/1.html" class="on">精彩视频</a>
          ...
          <div class="bar_x bar_x_n">
             ...
             <?php if ($data['list']):?>
            	...
            	<li data-src="<?php echo $v['datas']['str2'];?>"><a id="scale" href="javascript:;"><img src="<?php echo $v['datas']['str1'];?>" width="265" ></a><span><?php echo $v['datas']['label'];?></span><strong class="sp"></strong></li>

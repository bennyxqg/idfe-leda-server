...
<style type="text/css">
  ...
  .top .reserve {width: 2.06rem;height: .66rem;background: url(//dl.gamdream.com/activity/gavin/luren_offical/images/mobile_top_download.png) no-repeat center;background-size: 100% auto;}
  .top .reserve {display: block;overflow: hidden;text-indent: -999em;margin-right: .25rem;}

  .con .floor5 .download {position: absolute;top:0.7rem;  width: 2.24rem; left: 50%; margin-left: -1.12rem}
  .mreserve .floor5 ul {position: absolute;top: 2.1rem; padding: 0;margin: 0 1rem;}
...
<body data-id=<?=$siteId;?>>
  <div class="mreserve">
        <div class="top">
      <img class="icon" src="<?php echo GET_BLOCK('game_icon');?>" alt="">
      <div class="text">
        <?php echo GET_BLOCK('mobile_top_title');?>
      </div>
      <a class="reserve show-reserve">立即预约</a>
      <!-- <div class="burger">
        <div class="x"></div>
        <div class="y"></div>
        <div class="z"></div>
      ...
      <!-- <div class="menu">
        <ul>
          <li><a href="/">首页</a></li>
          <li><a class="new_state1" href="//mob100.uu.cc/news/2.html">资讯</a></li>
          <li><a class="new_state2" href="//mob100.uu.cc/news/3.html">公告</a></li>
          <li><a class="new_state3" href="//mob100.uu.cc/news/4.html">活动</a></li>
        </ul>
      </div> -->
    </div>
    <div class="con">
      <div class="floor floor1">
        ...
        <div class="btn-group">
          <img src="//dl.gamdream.com/activity/gavin/luren_offical/images/sem_download_button.png" alt="">
     ...
     <!--  <div class="floor floor4">
      ...
      <div class="floor floor5">
        <img src="//dl.gamdream.com/activity/gavin/luren_offical/images/m/background_06.jpg" alt="">

        <div class = "download">
        	<a class = "show-reserve">
        		<img src="//dl.gamdream.com/activity/gavin/luren_offical/images/mobile_bottom_download.png" alt="">
        	</a>
        </div>
  ...
  <script type="text/javascript" src="//dl.gamdream.com/activity/gavin/luren_offical/resource/login_pz.js"></script>
</body>
</html>
...
<div id="index">
    ...
    <div class="main1">
        ...
        <a href="/download" class="downLoad"><img src="<?php FILE_PATH(); ?>/wap/images/m_downLoad.png" alt="downLoad"></a>
        <a href="/download" class="downLoad"><img src="<?php FILE_PATH(); ?>/wap/images/m_downLoad.png" alt="downLoad"></a>
            ...
            <div class="banner">
                <div id="banner1" class="swiper-container">
                    <div class="swiper-wrapper">
                        <?php
                        SHOW_DATAS('<div class="swiper-slide"><a href="@@STR1@@"><img width="704" height="350" src="@@STR3@@" alt="banner"></a></div>',
                        'Y-m-d',0);
                         ?>
                    </div>
                    <!-- 如果需要分页器 -->

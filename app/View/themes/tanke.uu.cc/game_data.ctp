...
//$consulting =  $this->Tanke->newsInitData($page,$category_id);
        	...
        	<div class="wrap">
                ...
                <div class="pa nav">
                    <ul>
                        ...
                        <li class="on"><a href="//tanke.uu.cc/game_data/327.html" target="_self">游戏资料</a></li>
    ...
    <div class="page_main">
    	<div class="wrap">
        	<div class="pr page_nav">
            	<div class="item_nav">
                    <a <?php if ($category_id == 327) echo 'class="on"';?> href="//tanke.uu.cc/game_data/327.html" target="_self">坦克手册</a>
                    <a <?php if ($category_id == 325) echo 'class="on"';?>href="//tanke.uu.cc/game_data/325.html" target="_self">系统介绍</a>
                    <a <?php if ($category_id == 326) echo 'class="on"';?>href="//tanke.uu.cc/game_data/326.html" target="_self">游戏攻略</a>
                </div>
                <div class="pa site_nav">当前位置：<a href="//tanke.uu.cc" target="_self">首页</a> &gt; 资料</div>
            </div>
            <div class="news_list">
            	<ul>
            ...
            <?php echo $page; ?>
            <!--
            <div class="pages"><a href="#link">上一页</a><a class="on" href="#link">1</a><a href="#link">2</a><a href="#link">3</a><a href="#link">4</a><a href="#link">下一页</a></div>
       		-->
        </div>
    </div>

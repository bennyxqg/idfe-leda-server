...
<div class="top">
    ...
    <div class="wrap">
        ...
        <a class="pa android_down" href="<?php BLOCK('android_download_url') ?>"></a>
...
<div class="main">
	<div class="wrap">
    	<div class="video_box">
        	...
        	<div class="pa contrat_box"><a class="bbs_link" href="//bbs.uu.cc/forum-307-1.html" target="_blank">官方论坛</a></div>
        </div>

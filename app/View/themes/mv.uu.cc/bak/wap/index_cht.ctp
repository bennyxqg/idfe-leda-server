...
<meta content="<?php BLOCK('keywords_cht') ?>" name="keywords">
<meta content="<?php BLOCK('description_cht') ?>" name="description">
...
.footer{background:url(<?php BASE_URL() ?>images/foot2.jpg) no-repeat center top;height:172px;margin-top:70px;}
</style>
...
<div id="container">
  ...
  <div class="main">
     <a href="<?php BLOCK('wap_googleplay_url') ?>" class="az"><img src="<?php BASE_URL() ?>images/google.png" width="381" height="131" /></a>
     <p class="p1"><a href="<?php BLOCK('facebook_url') ?>" class="lunt"></a></p>
     <div class="video">
       <video src="<?php BLOCK('wap_index_vedio_url') ?>" width="500" height="300" controls="controls"></video>
     </div>
  </div>
  <div class="yx_jt"> 
     <div class="swiper-container">
        ...
        <?php
        	SHOW_IMAGE_LIST('<div class="swiper-slide"><img src="@@BIG_IMAGE@@" width="628" height="345" /></div>','wap_loop_img_cht',array());
        ?>
        </div>
        <!-- Add Pagination -->

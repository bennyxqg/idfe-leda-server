...
<div class="page">
    ...
    <div class="content clearfix">
        <div class="download fl">
            ...
            <h4 class="tit_hide">扫一扫</h4>
            <div class="info">
                <p>当前版本：v1.0.1<br />游戏大小：47.6M<br />适用固件：<br />Android 2.3.3 及以上</p>
                <img src="<?php echo $full_base_url ?>/images/wxxz.png" alt="" />
            </div>
        </div>
        <div class="video fr">
            <div id="video" style="width:474px;"><iframe height=254 width=450 src="//player.youku.com/embed/XNzk5MTc4NDAw" frameborder=0 allowfullscreen></iframe></div>
        </div>
    </div>
...
/* $(function(){
    $("#video").flowplayer({
        ...
        poster: '<?php echo $full_base_url ?>/images/fm.png',
        ratio: 3 / 4,
        autoplay: true
    });
}) */

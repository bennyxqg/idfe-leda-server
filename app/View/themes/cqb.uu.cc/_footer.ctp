...
<div class="footer">
    <span class="logo" style="height:105px;"><img src="<?php echo $full_base_url ?>/images/logo.png"><img src="<?php echo $full_base_url ?>/images/tshd.png" style="margin-left:20px;"></span>
    <div class="cr">

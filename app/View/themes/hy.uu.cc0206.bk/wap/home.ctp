...
<link rel="stylesheet" type="text/css" media="all" href="<?php BASE_URL() ?>css/style.sd.css?var=afafa"  />
<style type="text/css">
    ...
    <div class="main3">
        <div class="wrap">
            ...
            <div class="swiper-tese">
                <div class="swiper-wrapper">
                <?php
                    SHOW_DATAS('<div class="swiper-slide" style="background-image:url(//dl.gamdream.com/market/hy.uu.cc/20190103/1.jpg)"></div>',

    ...
    <div class="wrap">
        ...
        <ul>
            <li class="<?php if($this->view == "index"){echo "active";}?>">
              ...
              <li class="<?php if($this->view == "jnh"){echo "active";}?>">
                <a href="//hy.uu.cc/jnh" target="_self" style = "color:#FF0000;font-weight:bold">嘉&nbsp;年&nbsp;华<span style = "color:#FF0000;font-weight:bold">CARNIVAL</span></a>
            </li>

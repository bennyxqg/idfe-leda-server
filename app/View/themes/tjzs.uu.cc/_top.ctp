<div class="header">
    ...
    <div class="combox clearfix">
        ...
        <div class="wx fr">
            ...
            <li><a href="<?php BLOCK('ios_download_url') ?>"><img src="<?php BASE_URL() ?>css/img/download_ios.png"></a></li>
            <li><a href="<?php BLOCK('android_download_url') ?>"><img src="<?php BASE_URL() ?>css/img/download_az.png"></a></li>
        </div>
    </div>
    <!-- 浮层 -->
    <div class="package">

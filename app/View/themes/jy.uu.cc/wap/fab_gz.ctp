...
<div class="head">
    ...
    <div class="content fab-gz">
        ...
        <div class="fab-gz-des tc overflow-ellipsis">我们总梦想着一个属于自己的家，却长年漂泊在外。房子是租的，生活也要租吗？带着梦想，改造自己的小家吧。</div>
        <div class="cover-wrap">
            <div class="swiper-container">
                <div class="swiper-wrapper">
                    <!-- <div class="swiper-slide"><img class="slide-img" src="//dl.gamdream.com/activity/storm/jy/images/pic22.png"/></div>
                    <div class="swiper-slide"><img class="slide-img" src="//dl.gamdream.com/activity/storm/jy/images/pic22.png"/></div>
                    <div class="swiper-slide"><img class="slide-img" src="//dl.gamdream.com/activity/storm/jy/images/pic22.png"/></div>
                    <div class="swiper-slide"><img class="slide-img" src="//dl.gamdream.com/activity/storm/jy/images/pic22.png"/></div> -->
                    <?php
                        SHOW_DATAS('<div class="swiper-slide"><img class="slide-img" src="@@STR2@@" alt="@@STR1@@"></a></div>',
                    'Y-m-d',7);
                    ?>
                </div>
            </div>
    ...
    <script>
        ...
        var mySwiper = new Swiper ('.cover-wrap .swiper-container', {
            effect: 'coverflow',
            grabCursor: true,
            centeredSlides: true,
            slidesPerView: 'auto',

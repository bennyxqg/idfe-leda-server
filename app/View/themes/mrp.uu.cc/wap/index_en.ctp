...
.down_load{background:url(<?php BASE_URL() ?>images/bj03.jpg) no-repeat center top;height:695px;position:relative;}
...
.wz{background:url(<?php BASE_URL() ?>images/bander3.jpg) no-repeat center top;height:494px;}
...
.footer{background:url(<?php BASE_URL() ?>images/foot3.jpg) no-repeat center top;height:221px;}
...
<div id="container">
  <div class="down_load">
    <a href="<?php BLOCK('ios_download_url_en') ?>" class="ios" ><img src="<?php BASE_URL() ?>images/w_ios2.png" width="220" height="70"></a>
    <a href="javascript:;" class="az" data-type=""><img src="<?php BASE_URL() ?>images/w_az2.png" width="220" height="70"></a>
    <div class="link">
  ...
  <div class="yx_jt"> 
     <div class="swiper-container">
        <div class="swiper-wrapper">
        	<?php
        		SHOW_DATAS('<div class="swiper-slide"><img src="@@STR1@@" width="628" height="345" /></div>','m-d',2,100,1,array('OrderBy'=>'`int1` asc'));
			?>
        </div>
        <!-- Add Pagination -->
...
//	});
	function is_weixn(){
		...
		if(ua.match(/MicroMessenger/i)=="micromessenger"){
			...
			location.href="<?php BLOCK('android_download_url_en') ?>";
		}
	}
//	function is_weixn2(){
//		var u = navigator.userAgent;

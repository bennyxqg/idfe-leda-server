...
/*
@-webkit-keyframes float_r{
	0%{-webkit-transform:translate(0,0);}
	100%{-webkit-transform:translate(25px,25px);}
}
@-moz-keyframes float_r{
	0%{-moz-transform:translate(0,0);}
	100%{-moz-transform:translate(25px,25px);}
}
@-ms-keyframes float_r{
	0%{-ms-transform:translate(0,0);}
	100%{-ms-transform:translate(25px,25px);}
}
@-o-keyframes float_r{
	0%{-o-transform:translate(0,0);}
	100%{-o-transform:translate(25px,25px);}
}
@keyframes float_r{
...
@-webkit-keyframes float_l{
	0%{-webkit-transform:translate(0,0);}
	100%{-webkit-transform:translate(-25px,25px);}
}
@-moz-keyframes float_l{
	0%{-moz-transform:translate(0,0);}
	100%{-moz-transform:translate(-25px,25px);}
}
@-ms-keyframes float_l{
	0%{-ms-transform:translate(0,0);}
	100%{-ms-transform:translate(-25px,25px);}
}
@-o-keyframes float_l{
...
.mw2{/*-webkit-animation:mw2 2s  linear infinite both;-moz-animation:mw2 2s  linear infinite both;-ms-animation:mw2 2s  linear infinite both;-o-animation:mw2 2s  linear infinite both;animation:mw2 2s  linear infinite both;*/background:url(<?php BASE_URL() ?>images/mw3.png) no-repeat;width:202px;height:206px;bottom:100px;left:390px;z-index:7;}

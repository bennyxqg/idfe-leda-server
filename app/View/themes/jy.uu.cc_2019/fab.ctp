...
<style type="text/css"> 
	...
	.banner .wrap .down_btn {
    	width: 217px;
    	height: 74px;
    	background: url(//dl.gamdream.com/activity/jy/jy_game_download.png) no-repeat center;
   	 	display: block;
  		margin-left: 360px;
  	 	margin-top: -90px;
	}
...
<div class="topNav">
    <div class="wrap">
        ...
        <div class="game-home">
        		<a href = "https://jy.uu.cc/">
        		<img src = "//dl.gamdream.com/activity/jy/jy_join_game_home.png">
        		</a>
        	</a>'
        </div>
...
<div id="index" >
    <div class="banner">
        <div class="wrap">
            ...
            <div class="time_tit" style="background: url(//dl.gamdream.com/activity/jy/index_logo.png) no-repeat center;"></div>
            <a href="https://jy.uu.cc/" class="down_btn"></a>
        </div>
    </div>

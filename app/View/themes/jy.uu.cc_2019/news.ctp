...
<div class="pageMain">
    <div class="subHead">
        ...
        ?>
            <div class="title"><i></i><img src="<?php FILE_PATH() ?>/images/bg1_title.png" alt="资讯"></div>
       <?php
            }
        ?>
        <?php
        ...
        ?>
        <ul>
            <li class="<?php if($category_id == 1) echo "active";?>"><a href="//jy.uu.cc/news/1.html">最新</a></li>
            <li class="<?php if($category_id == 2) echo "active";?>"><a href="//jy.uu.cc/news/2.html">资讯</a></li>
            <li class="<?php if($category_id == 3) echo "active";?>"><a href="//jy.uu.cc/news/3.html">攻略</a></li>
        </ul>
        <?php
            }
        ?>

...
-->
    ...
    <div class="side fr">
        ...
        <div class="quick">
            <a class="td1" href="//bbs.uu.cc/forum-311-1.html">游戏论坛</a>
            <div class="td2" href="#">玩家QQ群<p class="qqDiv">我爱大富翁OL<br />467276195</p></div>
            <div class="td3">游戏微信<span><img src="<?php echo $full_base_url ?>/images/weixin.jpg"></span></div>
            <a class="td4" href="//weibo.com/u/5624897873" target="_blank">游戏微博</a>
        </div>
        <!-- <div class="video">

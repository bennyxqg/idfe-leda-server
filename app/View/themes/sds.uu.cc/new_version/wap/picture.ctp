...
<div id="container">
      ...
      <header class="top">
           <div class="left"><img src="<?php BLOCK('game_icon') ?>images/icon.png" width="103" height="103" /><img src="<?php BASE_URL() ?>images/icon_logo.png" width="193" height="56" /></div>
           <div class="right">
               <ul>
...
_HTML;
		  SHOW_DATAS($html,'m-d',6,100,1,array('OrderBy'=>'`int1` asc'));
          ?>

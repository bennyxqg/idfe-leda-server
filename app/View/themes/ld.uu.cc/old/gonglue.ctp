       ...
       <div class="n_right">
          ...
          <div class="article">
               <div class="message">
                 ...
                 <ul id="g_l" style="display:block;">
                 <?php if($topData['gong_lv']):?> 
	             	<?php foreach ($topData['gong_lv'] as $k=>$v):?>
	             		<li class="border"><strong>攻略</strong><a href="/show/<?php echo $v['id'];?>.html" target="_blank"><?php echo $v['title'];?></a><span><?php echo isset($v['updated'])?date('m/d',$v['updated']):'';?></span></li>
	             	<?php endforeach;?>
             	<?php endif;?>
                 </ul>
              </div>

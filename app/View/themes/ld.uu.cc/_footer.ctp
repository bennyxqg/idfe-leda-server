<div id="foot">
    <div class="footer">
        <span class="logo"><img src="<?php BASE_URL() ?>images/logo.png"><img style="margin-left:20px;" src="<?php BASE_URL() ?>images/gzxy.png"></span>
        <div class="cr">

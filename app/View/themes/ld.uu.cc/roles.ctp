...
<div class="top_nav">
	<div class="wrap">
        ...
        <ul class="pa nav">
            ...
            <li id="n3" class="on"><a href="<?php CATEGORY_URL('聚怪','roles') ?>">英雄介绍</a></li>
...
<div class="main clearfix">
	<div class="wrap">
        ...
        <div class="fr page_right">
        	<div class="pr page_top"><h2 class="tit">英雄介绍<i>HERO</i></h2><div class="pa site_nav"><a href="//ld.uu.cc/home">首页</a> &gt; <a>英雄介绍</a></div></div>
            <div class="page_list_box">
            	<div class="page_tab_hd">
                	<ul class="news_tab_hd hero_tab_hd">
                    	<li id="p1"<?php SHOW_IF_CATEGORY_ID_EQUAL(GET_CATEGORY_ID('聚怪'),' class="on"') ?>><a href="<?php CATEGORY_URL('聚怪','roles') ?>" target="_self">聚怪</a></li>
                        <li id="p2"<?php SHOW_IF_CATEGORY_ID_EQUAL(GET_CATEGORY_ID('输出'),' class="on"') ?>><a href="<?php CATEGORY_URL('输出','roles') ?>" target="_self">输出</a></li>
                        <li id="p3"<?php SHOW_IF_CATEGORY_ID_EQUAL(GET_CATEGORY_ID('破招'),' class="on"') ?>><a href="<?php CATEGORY_URL('破招','roles') ?>" target="_self">破招</a></li>
                    </ul>
                </div>
                <div class="roles_list clearfix">
                	<ul>
                		<?php
                			SHOW_NEWS('<li><a href="@@URL@@" target="_blank"><img src="@@BIG_IMAGE@@" /></a></li>','',GET_CATEGORY_NAME($category_id),100,0,array('OrderBy'=>'`sort` asc'));
                		?>

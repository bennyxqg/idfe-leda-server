...
<body>
    <div class="page page_guideDetail">
        ...
        <div class="news">
            ...
            <div class="newsDate">
                ...
                <div class="newsDate_date">发布于<? echo GET_CURRENT_NEWS_INFO('title');?></div>
        ...
        <div class="return-top">
            <a href="javascript:void(0)" class="return_top"><i><img src="images/return_top.png" alt="返回顶部"/></i>返回顶部</a>
        </div>
    </div> 

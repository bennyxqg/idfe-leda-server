...
$loopImageLeft = $webHelper->getImageList('loop_img_game'); // 左轮播图片
$loopImageRight = $webHelper->getImageList('index_right_loop_img'); // 右轮播图片
...
-->
    ...
    <div class="side fr">
        ...
        <div class="quick">
            <a class="td1" href="//bbs.uu.cc/forum-306-1.html">游戏论坛</a>
            <div class="td2" href="#">玩家QQ群<p class="qqDiv">X-觉醒群<br />88420552</p></div>
            <div class="td3">游戏微信<span><img src="<?php echo $full_base_url ?>/images/weixin.jpg"></span></div>
            <a class="td4" href="//weibo.com/ledoutgame" target="_blank">游戏微博</a>
        </div>
        <div class="video">
            <embed src="//static.video.qq.com/TPout.swf?vid=x0161hjg4bq&auto=0" allowFullScreen="true" quality="high" width="287" height="192" align="middle" allowScriptAccess="always" type="application/x-shockwave-flash"></embed>
        </div>
    </div>
</div>
<div class="footer">

...
$categories = $this->JZW->getNewsCategory(array('id' => $cateId)); // 正常显示的分类
$category = $categories[$cateId]; // 分类名称
$allCategories = $this->JZW->getNewsCategory(); // 所有新闻分类
$banner = $this->JZW->getSingleBlock('inner_banner');

$qrcodeDownloadAndroid = $this->JZW->getBlock($site_id, 'qrcode_download_android'); // Android下载二维码
$qrcodeWeixinImg = $this->JZW->getBlock($site_id, 'qrcode_weixin_image'); // 微信关注二维码
$downloadLink = $this->JZW->getBlock($site_id, 'android_download_url'); // 下载链接
        ...
        <div class="content">
            ...
            <div class="wd980">
                ...
                <div class="new_float">
                    ...
                    <?php else :?>
                    	<a class="game_load" href="<?php echo $downloadLink;?>">游戏下载</a>
                    <?php endif;?>

<?php 
$noticeCateIds = array('id' => $this->JZW->specialCategoryId); // 特殊显示的公告
$notices = $this->JZW->getNews($noticeCateIds, 0, 0, 'updated DESC', array('id', 'title', 'updated', 'created', 'news_categories_id', 'content')); // 公告
?>

...
<div class="pageMain clearfix">
    <div class="subHead">
       ...
       <?php
        ...
        ?>
        <ul>
            <li class="<?php if($category_id == 1) echo "active";?>"><a href="//hy.uu.cc/news/1.html">最新</a></li>
            <li class="<?php if($category_id == 2) echo "active";?>"><a href="//hy.uu.cc/news/2.html">新闻</a></li>
            <li class="<?php if($category_id == 3) echo "active";?>"><a href="//hy.uu.cc/news/3.html">公告</a></li>
            <li class="<?php if($category_id == 4) echo "active";?>"><a href="//hy.uu.cc/news/4.html">活动</a></li>
        </ul>
        <?php
            }
        ?>

...
<div class="topNav">
    <div class="wrap">
        ...
        <ul>
            ...
            <li class="<?php echo $this->view;if($this->view == "index"){echo "active";}?>">
                <a href="//mhhy.dl.gxpan.cn/tmp/hy/mhhyPc-webpack/pages/indexOnline.html" target="_self">御苑云游<span>Palace</span></a>
            </li>

...
<body class="page">
    <div id="page-content">
        ...
        <div class="page-main">
            <div class="wrap">
                <div class="news-tabs">
                    <a <?php if ($category_id == 98) echo 'class="active"';?> href="//hy.uu.cc/news/98.html">最新</a>
                    <a <?php if ($category_id == 369) echo 'class="active"';?> href="//hy.uu.cc/news/369.html">新闻</a>
                    <a <?php if ($category_id == 372) echo 'class="active"';?> href="//hy.uu.cc/news/372.html">攻略</a>
                </div>
                <div id="news-tabs-container">
                    <ul>
                        <?php
                            ...
                            SHOW_NEWS('<li><a href="@@URL@@" target="_blank">@@TITLE@@<span>[@@DATE@@]</a></span></li>','Y/m/d',$config[$category_id],10,$page,array());
                        ?>
                    </ul>
                </div>

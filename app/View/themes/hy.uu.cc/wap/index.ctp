...
<head>
    ...
    <style type="text/css">
        ...
        .main1 .enter{
            ...
            background: url("//mhhy.dl.gxpan.cn/tmp/hy/mobile-start-yunyb-v2@2x.png") no-repeat;
        ...
        a.downlink{
            ...
            left: 58px;
            bottom: 46px;
            background: url("//mhhy.dl.gxpan.cn/tmp/hy/mobile-start-xiazb-v2@2x.png") no-repeat;
            background-size: 100% 100%;
            animation:heartbeat 1s infinite;
        }
    </style>
...
<div id="content" style="background: url('//mhhy.dl.gxpan.cn/tmp/hy/mobile-homepage-bg-v2@2x.png') no-repeat;background-size: 100% auto">-->
    <div class="top">
        <div class="logo">
        ...
        <div class="menu">
            <ul>
                ...
                <li><a href="//mhhy.dl.gxpan.cn/tmp/hy/mhhyMobile-webpack-mini/pages/index.html">御苑云游</a></li>
    ...
    <div class="pr main1">
        ...
        <?php echo GET_BLOCK('phone_btn');?>
        <a href="//mhhy.dl.gxpan.cn/tmp/hy/mhhyMobile-webpack-mini/pages/index.html" class="enter"></a>
    </div>
    <div class="main2">
        <div class="wrap">
    ...
    <div class="main3">
        <div class="wrap">
            <div class="item-tit"><img src="<?php BASE_URL() ?>images/itemTit2.png"></div>
    ...
    <div class="main5">
        <div class="wrap">
            <div class="item-tit"><img src="<?php BASE_URL() ?>images/itemTit3.png"></div>
            ...
            <a class="more clearfix" href="#link">查看更多</a>
        </div>
    </div>
</div>
...
<div class="main6">
    <div class="wrap">
        <div class="item-tit"><img src="<?php BASE_URL() ?>images/itemTit4.png?v=0"></div>

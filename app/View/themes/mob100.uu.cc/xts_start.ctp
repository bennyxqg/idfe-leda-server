    ...
    <div class="dialog-share pop pop-share">
      <div class="el-dialog" style="margin-top: 25vh; width: 739px;">
        ...
        <div class="el-dialog__body">
          <div class="focus_box">
            <img src="//dl.gamdream.com/mike/luren/img/123.png" alt="" class="qrcode">
            <div class="detail">
...
<script type="text/javascript" src="//dl.gamdream.com/activity/gavin/passerbyNewtalk/resource/index.js"></script>
</html>
...
<body data-id=<?=$siteId;?>>
    ...
    <div class="con">
      ...
      <div class="floor floor5">
        <img src="//dl.gamdream.com/activity/gavin/luren_offical/images/m/background_06.jpg" alt="">
         <div class = "download">
           <a  class = "show-reserve" style = "cursor:pointer;">
               <img src="//dl.gamdream.com/activity/gavin/luren_offical/images/m/point_btn.png" alt="">
           </a>
        </div>
        <ul>
          <li>
  ...
  <script type="text/javascript" src="//dl.gamdream.com/activity/gavin/luren_offical/resource/login_sem.js"></script>
</body>
</html>
...
<style type="text/css">
  ...
  .pcnews .category .subject{margin-top: 15px;}
   ...
   .share-pop {position: fixed;background: url(//dl.gamdream.com/activity/storm/mob100/images/floating-qrcode-pop-bg.png) no-repeat center;height: 302px;width: 168px;right: 70px;z-index: 10}
   .share-pop .qrcode {position: relative;margin: 0 auto;width: 105px;height: 105px;display: block;top: 30px;}
   .share-pop .weibo-link {position: relative;width: 110px;height: 35px;display: block;margin: 0 auto;top: 65px;}
   .share-pop .qq-link {position: relative;width: 110px;height: 35px;display: block;margin: 0 auto;top: 65px;}
   .share-pop .show-top {position: relative;width: 110px;height: 35px;display: block;margin: 0 auto;top: 95px;}
</style>
<body>
  <div class="pcnews">
...
<!--     <div class="qrcode_box">
    ...
    <section class="wrap category">
      ...
      <ul class="tab">
        ...
        <li class="tab-item <?php if($category_id == 2){ echo "tab-item--active"; } ?>"><a href="//mob100.uu.cc/news/2.html">新闻</a></li>
        ...
        <li class="tab-item <?php if($category_id == 5){ echo "tab-item--active"; } ?>"><a href="//mob100.uu.cc/news/5.html">攻略</a></li>
      </ul>
    </section>
    <?php 
        $config = array(
                1 => array('新闻','公告','活动','萌新指引','伙伴超能','除灵副本'),
                2 => array('新闻'),
                3 => array('公告'),
                4 => array('活动'),
    ...
    <ul class="news">
      <?php
            SHOW_NEWS('<li class="news-block">
                <span class="tag blue" style = "width:75px">[@@CATEGORY_NAME@@]</span>
                <a href="@@URL@@"> 
                  <h3>@@TITLE@@</h3>

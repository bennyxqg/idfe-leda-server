<div class="footer">
    <div class="wrap">
        <span class="logo"><img src="<?php BASE_URL() ?>images/ft_logo1.png"><img style="width:40px;opacity:0;" src="<?php BASE_URL() ?>images/ft_logo2.png?v=0"></span>
        <div class="cr">

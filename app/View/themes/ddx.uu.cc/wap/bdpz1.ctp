...
<div id="container" style="display:none;">
    ...
    <section class="part2"><img src="<?php BASE_URL() ?>images/bdpz/p2.jpg" width="640" height="678" /><a href="https://itunes.apple.com/cn/app/kuai-le-dian-dian-xiao-he/id1023663634?mt=8" class="down down_load"></a>
    ...
    <footer>
       ...
       <a class="down_load" href="https://itunes.apple.com/cn/app/kuai-le-dian-dian-xiao-he/id1023663634?mt=8"><img src="<?php BASE_URL() ?>images/bdpz/down_load.png" width="307" height="53" /></a>
    </footer>
</div>
</body>
           ...
           //console.log(browser);
				if (/(iPhone|iPad|iPod|iOS)/i.test(navigator.userAgent)) {
                    ...
                    $('.down_load').on('touchstart',function(){
						   $.ajax({
									type:"GET",
									url:"//ddx.uu.cc/act/statistics?referer=ddx.uu.cc.bdpz1&platform=ios",
									dataType:"json",
					...
					$('.down_load').on('touchstart',function(){
						   $.ajax({
									type:"GET",
									url:"//ddx.uu.cc/act/statistics?referer=ddx.uu.cc.bdpz1&platform=android",
									dataType:"json",
									success:function(res){
									}
							});	

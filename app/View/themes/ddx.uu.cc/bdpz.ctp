...
<div class="pr nav">
    ...
    <h2><b>快乐点点消</b><span>何炅代言-超人气消除手游</span></h2>
...
<div class="main1">
	<div class="wrap">
        ...
        <div class="pa down_btns"><a class="ios_down" href="https://itunes.apple.com/cn/app/kuai-le-dian-dian-xiao-he/id1023663634?mt=8" target="_blank" title="App Store下载"></a><a class="android_down" href="//dl.uu.cc/idreamsky/ToyBlast-20_v1.3.0.0_s2.4.9.8_p3.2.2.12_AllPay_360sec_LD0S0N50005.apk" target="_blank" title="安卓下载"></a></div>
...
<div class="main4 clearfix">
	<div class="wrap">
        ...
        <div class="clearfix">
            ...
            <div class="fr media_box video_box">
                <h2 class="media_tit">游戏视频</h2>
                <ul>
                <?php
                	SHOW_DATAS('<li><a class="video_btn_link" name="@@STR2@@" href="javascript:;"><img src="@@STR1@@" /><span></span></a></li>','m-d',0,4,0,array());
                ?>
                </ul>
            </div>
        </div>
...
<div class="footer">
    <div class="wrap">
        <span class="logo"><img src="<?php BASE_URL() ?>images/ft_logo1.png" /><img src="<?php BASE_URL() ?>images/ft_logo2.png" /></span>
        <div class="cr">

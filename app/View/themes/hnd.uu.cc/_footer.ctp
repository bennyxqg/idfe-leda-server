<div id="foot">
    <div class="footer">
        <span class="logo"><a href="//www.idreamsky.com" target="_blank"><img src="//ld.uu.cc/ld.uu.cc/images/logo.png"></a></span>
        <div class="cr">

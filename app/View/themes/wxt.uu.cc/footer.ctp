<div id="foot">
	<div class="footer">
		<div class="cr">
			<span class="logo"><img src="<?php BASE_URL() ?>yuyue20171017/images/f_logo.png"><img style="margin-left:20px;" src="<?php BASE_URL() ?>yuyue20171017/images/foot_logo2.png"></span>
				<div class="demo">
				<div class="bd">
					<div class="tempWrap" style="overflow:hidden; position:relative; width:464px">
						<ul style="width: 3480px; position: relative; overflow: hidden; padding: 0px; margin: 0px; left: -530px;">
															
						<?php if (!empty($topData['data_22'])): ?>
					<?php foreach ($topData['data_22'] as $k =>$v):?>
					<li style="float: left; width: 100px;"><a href="<?php echo $v['str2']; ?>" target="_blank"><img src="<?php echo $v['str1']; ?>" /></a></li>
					<?php endforeach; ?>
					<?php endif; ?>
						</ul></div>
				</div>
				...
				<div class="hezuo">
					<a href="javascript:;" class="hz_hover"><img src="<?php BASE_URL() ?>yuyue20171017/images/hezuo.jpg" width="285" height="35"></a>
					<ul class="bar_hz" style="display: none;">
		...
		<div class="messages">
			...
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			深圳市创梦天地科技有限公司  版权所有<br>  粤ICP备11018438号 &nbsp; 粤网文〔2016〕6871-1632号 批准文号：文网游备字〔2016〕Ｍ-RPG 7445 号   <br> 新广出审[2017]1900号 出版号：ISBN  978-7-7979-5402-0</span> 
			...
			<a target="_blank" href="http://sq.ccm.gov.cn:80/ccnt/sczr/service/business/emark/gameNetTag/4028c08c5829652f01582e1467490bee"> <img src="<?php BASE_URL() ?>images/w_foot2_icon2.png" alt="电子标签" width="16"> </a></p>
		</div>
	</div>
</div>